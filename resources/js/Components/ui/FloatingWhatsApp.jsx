                    ...
                    <AnimatePresence>
                        {showChat && (
                            ...
                            >
                                ...
                                <div className="p-6 bg-[#f0ede9] min-h-[140px] flex flex-col gap-4 relative">
                                    ...
                                    >
                                        <p className="text-sm text-gray-800 font-bold leading-relaxed">
                                            Halo Ayah/Bunda! 👋 <br />
                                            Ada yang bisa kami bantu seputar layanan tumbuh kembang anak di EDUfa? Silakan pilih Admin di bawah untuk berkonsultasi.
                                        </p>
                                ...
                                {/* Bottom Links for both WhatsApp numbers */}
                                <div className="flex flex-col border-t border-gray-100 divide-y divide-gray-100 bg-white">
                                    <a
                                        href={waLink1}
                                        target="_blank"
