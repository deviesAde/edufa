...
export default function PendampinganABKdiSekolah() {
    return (
            ...
            <main className="pb-0">
                ...
                <div className="relative py-12 lg:py-20 overflow-hidden bg-white">
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
                        ...
                        >
                            <RevealText text="Pendampingan" className="text-gray-900" />{' '}
                            <span className="relative inline-block mt-2">
                                <RevealText text="ABK di Sekolah" className="text-edufa-blue" delay={0.5} />
                                <motion.svg 
                                    viewBox="0 0 400 20" 
